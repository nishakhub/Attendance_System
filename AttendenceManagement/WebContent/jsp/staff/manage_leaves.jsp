...
<body>
							...
							<div class="form-group col-md-4">
								<label for="">From :</label>
									<div class="input-group date" id="fromdp" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
				        				<input class="form-control" id="leave_from-date" type="text"> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				    				</div>
							</div>
							<div class="form-group col-md-4">
								<label for="">To:</label>
									<div class="input-group date" id="todp" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
				        				<input class="form-control" id="leave-to-date" type="text"> <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				    				</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-8">
								...
								class="form-control" id="leave_reason" name="address"></textarea>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-8">
	...
	$(document).ready(function() {
		...
		$("#div-apply-for-leaves").hide();
			...
			$("#btn-apply-leaves").click(
					function() {
						$.ajax({
							type : "POST",
							url : "/AttendenceManagement/adminService",
							data : {
								fromDate : $("#leave-to-date").val(),
								toDate : $("#leave-from-date").val(),
								desription : $("#leave_reason").val(),
								requestType : "applyLeaves"
							},
							success : function(result) {
								$("#holiday-table-body").html(result);
